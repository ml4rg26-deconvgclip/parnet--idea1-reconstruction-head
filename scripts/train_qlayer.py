"""Train GlobalCLIPQLayerModel (QLayer interference + dilated CNN).

Usage:
    pixi run -e parnet-dev-cu12 python scripts/train_qlayer.py
    pixi run -e parnet-dev-cu12 python scripts/train_qlayer.py --lr 3e-4 --run-id v2
"""
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--run-id",        default="globalclip.qlayer.v1")
...
def main() -> None:
    ...
    log.info(f"  QLayer phases: {model.qlayer.phase.numel()}")
